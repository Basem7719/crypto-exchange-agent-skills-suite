...
**Category:** router   |   **Mode:** both   |   **Exchanges:** Binance, OKX

> Master orchestrator for centralized crypto exchange (CEX) trading on Binance and OKX. Use this skill whenever the user mentions Binance, OKX, Bybit, HTX, "the exchange", spot trading, futures trading, perpetuals, leverage, a trading pair like BTC/USDT or ETH/USDT, market scanning
...
```
crypto-exchange-master  →  routes user requests  →  crypto-exchange-master  →  hands off to next skill
```
